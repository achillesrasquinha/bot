...
from bot.commands.util 	import cli_format
...
from bot.exception      import DependencyNotFoundError
...
"bot". Kindly post an issue at https://github.com/achillesrasquinha/bot/issues""", cli.RED))
        else:
            raise e
